...
def data_load(args): 
    ...
    dsets["source_tr"] = ImageList(tr_txt, root="../data/{}/train/".format(args.dset), transform=image_train())
    dset_loaders["source_tr"] = DataLoader(dsets["source_tr"], batch_size=train_bs, shuffle=True, num_workers=args.worker, drop_last=False)
    dsets["source_te"] = ImageList(te_txt, root="../data/{}/train/".format(args.dset), transform=image_test())
    ...
    dsets["test"] = ImageList(txt_test, root="../data/{}/validation/".format(args.dset), transform=image_test())
